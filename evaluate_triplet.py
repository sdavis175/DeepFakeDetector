...
if __name__ == "__main__":
    ...
    test_data = pd.read_csv("../Celeb-DF-v2/List_of_testing_videos.txt", delimiter=" ")
    ...
    model = load_model("trained_wts/triplets_semi_hard.hdf5",
    ...
    for i in videos:
        print("../Celeb-DF-v2/" + i)
        cap = cv2.VideoCapture(os.path.join("../Celeb-DF-v2/" , i))
        batches = []
        mounting = 0
