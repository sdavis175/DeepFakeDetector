...
real_videos = [os.path.join("../face_frames_split/face_frames_split/training/real", video_folder) for video_folder in os.listdir("../face_frames_split/face_frames_split/training/real")]
synthetic_videos = [os.path.join("../face_frames_split/face_frames_split/training/synthesis", video_folder) for video_folder in os.listdir("../face_frames_split/face_frames_split/training/synthesis")]
